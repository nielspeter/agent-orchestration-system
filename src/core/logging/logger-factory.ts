import { AgentLogger, LoggingConfig } from './logger.interface';
import { CompositeLogger } from './implementations/composite-logger';
import { ConsoleLogger } from './implementations/console-logger';
import { JsonlLogger } from './implementations/jsonl-logger';
...
class NoOpLogger implements AgentLogger {
  ...
  logToolCall(_agent: string, _tool: string, _params: any): void {}
  logToolExecution(_agent: string, _tool: string, _toolId: string): void {}
  logToolResult(_agent: string, _tool: string, _toolId: string, _result: any): void {}
